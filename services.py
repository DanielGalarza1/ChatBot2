...
def textReply_Message(number, body, footer, seed, messageId):
    """
    Envía un mensaje de texto como respuesta.
    
    Args:
        number (str): El número de teléfono del destinatario.
        body (str): El contenido principal del mensaje.
        footer (str): El pie de página del mensaje.
        seed (str): Un identificador único para el mensaje.
        messageId (str): El ID del mensaje al que se está respondiendo.
        
    Returns:
        dict: Un diccionario con la información del mensaje enviado.
    """
    message = {
        "messaging_product": "whatsapp",
        "to": number,
